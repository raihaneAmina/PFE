...
public class appd extends JFrame {
	...
	public appd() {
		...
		panel_1.setBounds(0, 214, 851, 316);
		...
		JLabel lblCre = new JLabel("Ordre De Passage \r\n");
		...
		lblDesExamens.setHorizontalAlignment(SwingConstants.CENTER);
		lblDesExamens.setFont(new Font("Trebuchet MS", Font.BOLD, 15));
		lblDesExamens.setBounds(0, 145, 209, 53);
		panel.add(lblDesExamens);
		...
		lblUniversitDjilaliBounaama.setBounds(160, 110, 393, 28);
		...
		label_1.setBounds(160, 144, 393, 28);
		panel_2.add(label_1);
